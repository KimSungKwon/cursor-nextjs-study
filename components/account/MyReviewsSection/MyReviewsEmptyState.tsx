...
export type MyReviewsEmptyStateProps = {
  className?: string;
};

/**
 * 작성한 리뷰가 없을 때 표시하는 빈 상태 UI
 */
export const MyReviewsEmptyState = ({ className }: MyReviewsEmptyStateProps) => {
  return (
    <div
      className={cn(
