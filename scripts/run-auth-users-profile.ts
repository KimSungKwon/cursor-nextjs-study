...
const MIGRATION_FILE = "supabase/migrations/0006_auth_users_profile.sql";
...
async function runAuthUsersProfile(): Promise<void> {
  loadEnvLocal();
...
runAuthUsersProfile().catch((error: unknown) => {
