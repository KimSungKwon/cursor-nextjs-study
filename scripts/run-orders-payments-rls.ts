...
// orders/payments 소유자 INSERT·UPDATE RLS
const MIGRATION_FILE =
  "supabase/migrations/0009_orders_payments_owner_policies.sql";
...
async function runOrdersPaymentsRls(): Promise<void> {
  loadEnvLocal();
...
runOrdersPaymentsRls().catch((error: unknown) => {
