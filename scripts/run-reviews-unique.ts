...
const MIGRATION_FILE = "supabase/migrations/0007_reviews_user_product_unique.sql";
...
async function runReviewsUnique(): Promise<void> {
  loadEnvLocal();
...
runReviewsUnique().catch((error: unknown) => {
